...
public class ItemsApiController implements ItemsApi {
    ...
    public ResponseEntity<Void> deleteItemById(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
    ...
    public ResponseEntity<Item> getItemById(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<Item> saveItem(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Item body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Item>(objectMapper.readValue("{\n  \"quantity\" : 6,\n  \"price\" : 0.8008281904610115,\n  \"name\" : \"name\",\n  \"description\" : \"description\",\n  \"id\" : \"id\"\n}", Item.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Item> updateItem(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") String id,@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Item body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Item>(objectMapper.readValue("{\n  \"quantity\" : 6,\n  \"price\" : 0.8008281904610115,\n  \"name\" : \"name\",\n  \"description\" : \"description\",\n  \"id\" : \"id\"\n}", Item.class), HttpStatus.NOT_IMPLEMENTED);
